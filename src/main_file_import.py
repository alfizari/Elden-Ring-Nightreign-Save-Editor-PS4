...
def decrypt_ds2_sl2_import(input_file, log_callback=None) -> Dict[int, str]:
    ...
    output_folder = os.path.join(script_dir, "decrypted_output_import")
    ...
    return os.path.join(os.path.dirname(os.path.abspath(__file__)), "decrypted_output_import")
...
def encrypt_modified_files_import(output_sl2_file):
